...
it('can launch a site', function () {
    command(base_path('bellows launch'))
        ...
        ->waitForPlugin('PlanetScale')
        ->deny('Enable PlanetScale')
